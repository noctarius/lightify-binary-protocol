...
| 1
| Fixed white, dimmable, non-softswitch

| 2
| Lightify bulb (TW), dimmable, soft-switchable

| 4
| Fixed white, dimmable, soft-switchable

| 10
| Lightify bulb (RGBW), dimmable, soft-switchable
...
So far it seems like there's a bitmask defining the capability of the devices. Some of the bits seem to be known by now.
